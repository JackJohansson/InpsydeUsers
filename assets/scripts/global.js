...
(function ( $ ) {
    ...
    function inpsydeGetUserDetails( userId )
    {
        ...
        $.ajax(
            {
                url: inpsyde.rest_url.base + inpsyde.rest_url.user_details,
                method: 'GET',
    ...
    function inpsydeFillDatatable( reset = false )
    {
        ...
        table.DataTable({
            ...
            processing: true,
            ajax: {
                url: inpsyde.rest_url.base + inpsyde.rest_url.users,
                type: 'GET',
                data: {
                    pagination: {
                        perpage: 10,
    ...
    $('#inpsyde-flush-users').on('click', function ( e ) {
        ...
        $.ajax(
            {
                url: inpsyde.rest_url.base + inpsyde.rest_url.users_flush,
                method: 'DELETE',
    ...
    $('#inpsyde-refresh-details').on('click', function ( e ) {
        ...
        $.ajax(
            {
                url: inpsyde.rest_url.base + inpsyde.rest_url.user_flush,
                method: 'DELETE',
